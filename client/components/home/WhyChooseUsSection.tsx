...
export default function WhyChooseUsSection({
  ...
  return (
    <section className="w-full" style={{ backgroundColor: "#EFF0EB" }}>
      <div className="max-w-[2560px] mx-auto w-[95%] md:w-[90%] lg:w-[80%] pt-[60px] md:pt-[84px] pb-[60px] md:pb-[84px]">
        <div className="max-w-[1040px] mx-auto text-center">
          ...
          {content.description?.trim() && (
            <RichText
              ...
              className="mt-[20px] md:mt-[24px] max-w-[940px] mx-auto text-black rich-text [&_p]:font-outfit [&_p]:text-[16px] md:[&_p]:text-[20px] [&_p]:leading-[28px] md:[&_p]:leading-[32px] [&_p]:text-black [&_p]:mb-[22px] md:[&_p]:mb-[28px] [&_p:last-child]:mb-0"
            />
          )}
        </div>
      </div>
